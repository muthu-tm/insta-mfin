...
class EditorsActionButtons extends StatelessWidget {
  EditorsActionButtons(this.onPressedSave, this.onPressedCancel,
      [this.saveTitle = "Save", this.closeTitle = "Close"]);
