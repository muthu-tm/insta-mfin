...
class CollectionEntryHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: journalAppBar(context,"Payment Entries",'/transactions/journal/categories',PaymentTemplateWidget(_scaffoldKey)),
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => PaymentTemplateWidget(_scaffoldKey),
              settings: RouteSettings(name: '/transactions/payments/template/add'),
            ),
          );
        },
        label: Text(
