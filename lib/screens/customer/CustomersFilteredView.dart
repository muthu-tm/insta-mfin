...
class CustomersFilteredView extends StatefulWidget {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

  @override
  _CustomersFilteredViewState createState() => _CustomersFilteredViewState();
}

class _CustomersFilteredViewState extends State<CustomersFilteredView> {
  int status = 0;
